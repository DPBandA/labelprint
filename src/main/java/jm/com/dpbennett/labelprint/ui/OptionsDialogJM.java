 ...
 */
public class OptionsDialogJM extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public OptionsDialogJM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new OptionsDialogJM(new javax.swing.JFrame(), true).setVisible(true);
        });
    }
