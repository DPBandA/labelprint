...
import static org.apache.batik.bridge.SVGUtilities.getDescription;
 ...
 * image files:
 *
 * JFileChooser chooser = new JFileChooser(); LabelPrintFileFilter filter = new
 * LabelPrintFileFilter( new String{"gif", "jpg"}, "JPEG & GIF Images")
 * chooser.addChoosableFileFilter(filter); chooser.showOpenDialog(this);
 */
public class LabelPrintFileFilter extends FileFilter {
     ...
     * @see #addExtension
     */
    public LabelPrintFileFilter() {
        this.filters = new HashMap();
    }

    /**
     * Creates a file filter that accepts files with the given extension.
     * Example: new LabelPrintFileFilter("jpg");
     *
     * @param extension
     * @see #addExtension
     */
    public LabelPrintFileFilter(String extension) {
        this(extension, null);
    }

    /**
     * Creates a file filter that accepts the given file type. Example: new
     * LabelPrintFileFilter("jpg", "JPEG Image Images");
     *
     ...
     * @see #addExtension
     */
    public LabelPrintFileFilter(String extension, String description) {
        this();
        if (extension != null) {
     ...
     * LabelPrintFileFilter(String {"gif", "jpg"});
     *
     ...
     * @see #addExtension
     */
    public LabelPrintFileFilter(String[] filters) {
        this(filters, null);
    }

    /**
     * Creates a file filter from the given string array and description.
     * Example: new LabelPrintFileFilter(String {"gif", "jpg"}, "Gif and JPG
     * Images");
     *
     ...
     * @see #addExtension
     */
    public LabelPrintFileFilter(String[] filters, String description) {
        this();
     ...
     *
     * LabelPrintFileFilter filter = new LabelPrintFileFilter();
    ...
    public String getDescription() {
        if (fullDescription == null) {
            if (description == null || isExtensionListInDescription()) {
                ...
                Set set = filters.keySet();
                int i = 0;
                for (Object key : set) {
                    if (i == 0) {
                        fullDescription += "." + (String) key;
                    } else {
                        fullDescription += ", " + (String) key;
                    }
                    i++;
